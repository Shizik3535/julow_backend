...
class OnTaskOverdueNotify(BaseEventHandler[dict[str, Any]]):
    """
    Обработчик события TaskOverdue из Task BC.

    Создаёт task_overdue уведомление для каждого исполнителя задачи.
    """
