...
class OnProjectOverdueNotify(BaseEventHandler[dict[str, Any]]):
    """
    Обработчик события ProjectOverdue из Project BC.

    Создаёт project_overdue уведомление для каждого участника проекта.
    """
    ...
    async def handle(self, event: dict[str, Any]) -> None:
        ...
        for user_id in member_ids:
            ...
            if await self._repo.has_unread_by_type_and_target(
                ...
                notification_type=NotificationType.PROJECT_OVERDUE,
