...
class OnSprintStartedNotify(BaseEventHandler[dict[str, Any]]):
    """
    Обработчик события SprintStarted из Project BC.

    Создаёт sprint_started уведомление.
    """
