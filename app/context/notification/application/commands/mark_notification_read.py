...
class MarkNotificationReadCommand(BaseCommand):
    """
    Команда пометки уведомления как прочитанного.
...
class MarkNotificationReadHandler(BaseCommandHandler[MarkNotificationReadCommand, None]):
    ...
    async def handle(self, command: MarkNotificationReadCommand) -> None:
