...
class ChangeWorkspaceMemberRoleCommand(BaseCommand):
    """
    Команда смены роли участника workspace.
...
class ChangeWorkspaceMemberRoleHandler(BaseCommandHandler[ChangeWorkspaceMemberRoleCommand, None]):
    """Обработчик смены роли участника workspace."""
