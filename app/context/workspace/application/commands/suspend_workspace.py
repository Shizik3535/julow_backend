...
class SuspendWorkspaceCommand(BaseCommand):
    """
    Команда приостановки workspace.
...
class SuspendWorkspaceHandler(BaseCommandHandler[SuspendWorkspaceCommand, None]):
    """Обработчик приостановки workspace."""
    ...
    async def handle(self, command: SuspendWorkspaceCommand) -> None:
        ...
        ws.suspend(reason=command.reason)
