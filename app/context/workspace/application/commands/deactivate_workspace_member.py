...
class DeactivateWorkspaceMemberCommand(BaseCommand):
    """
    Команда деактивации участника workspace.
...
class DeactivateWorkspaceMemberHandler(BaseCommandHandler[DeactivateWorkspaceMemberCommand, None]):
    """Обработчик деактивации участника workspace."""
    ...
    async def handle(self, command: DeactivateWorkspaceMemberCommand) -> None:
