...
class RequestWorkspaceDeletionCommand(BaseCommand):
    """
    Команда запроса удаления workspace.
...
class RequestWorkspaceDeletionHandler(BaseCommandHandler[RequestWorkspaceDeletionCommand, None]):
    """Обработчик запроса удаления workspace."""
