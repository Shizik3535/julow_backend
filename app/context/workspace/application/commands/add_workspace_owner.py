...
class AddWorkspaceOwnerCommand(BaseCommand):
    """
    Команда добавления со-владельца workspace.
...
class AddWorkspaceOwnerHandler(BaseCommandHandler[AddWorkspaceOwnerCommand, None]):
    """Обработчик добавления со-владельца workspace."""
    ...
    async def handle(self, command: AddWorkspaceOwnerCommand) -> None:
        ...
        ws.add_owner(user_id=Id.from_string(command.user_id))
