...
class ReactivateWorkspaceCommand(BaseCommand):
    """
    Команда реактивации workspace.
...
class ReactivateWorkspaceHandler(BaseCommandHandler[ReactivateWorkspaceCommand, None]):
    """Обработчик реактивации workspace."""
    ...
    async def handle(self, command: ReactivateWorkspaceCommand) -> None:
