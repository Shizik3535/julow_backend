...
class UpdateWorkspaceInfoHandler(BaseCommandHandler[UpdateWorkspaceInfoCommand, None]):
    ...
    async def handle(self, command: UpdateWorkspaceInfoCommand) -> None:
        ...
        if has_pers:
            ...
            has_branding = any([command.cover_image_url, command.custom_css])
            if has_branding:
                branding = WorkspaceBranding(
                    logo_url=ws.personalization.branding.logo_url if ws.personalization.branding else None,
            ...
            personalization = WorkspacePersonalization(
                ...
                icon=command.icon if command.icon else ws.personalization.icon,
