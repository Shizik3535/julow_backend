...
class UpdateWorkspaceMemberDisplayNameCommand(BaseCommand):
    """
    Команда обновления отображаемого имени участника workspace.
...
class UpdateWorkspaceMemberDisplayNameHandler(BaseCommandHandler[UpdateWorkspaceMemberDisplayNameCommand, None]):
