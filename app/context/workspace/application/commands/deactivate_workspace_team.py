...
class DeactivateWorkspaceTeamCommand(BaseCommand):
    """
    Команда деактивации команды workspace.
...
class DeactivateWorkspaceTeamHandler(BaseCommandHandler[DeactivateWorkspaceTeamCommand, None]):
    """Обработчик деактивации команды workspace."""
    ...
    async def handle(self, command: DeactivateWorkspaceTeamCommand) -> None:
