...
class RemoveWorkspaceOwnerCommand(BaseCommand):
    """
    Команда удаления со-владельца workspace.

    Атрибуты:
        caller_id: ID пользователя, выполняющего операцию.
        workspace_id: ID workspace.
        user_id: ID владельца для удаления.
    """
...
class RemoveWorkspaceOwnerHandler(BaseCommandHandler[RemoveWorkspaceOwnerCommand, None]):
    """Обработчик удаления со-владельца workspace."""
