...
class ArchiveTaskCommand(BaseCommand):
    """
    Команда архивации задачи.
...
class ArchiveTaskHandler(BaseCommandHandler[ArchiveTaskCommand, None]):
    ...
    async def handle(self, command: ArchiveTaskCommand) -> None:
