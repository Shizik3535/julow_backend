...
class RestoreTaskCommand(BaseCommand):
    """
    Команда восстановления задачи.
...
class RestoreTaskHandler(BaseCommandHandler[RestoreTaskCommand, None]):
    ...
    async def handle(self, command: RestoreTaskCommand) -> None:
