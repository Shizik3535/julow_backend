...
class InvitationNotFoundException(EntityNotFoundException):
    ...
    def __init__(self, id: object) -> None:
        super().__init__(entity_type="Invitation", id=id)
...
class CircularDepartmentException(BusinessRuleViolationException):
    """Циклическая ссылка в иерархии подразделений."""

    def __init__(self) -> None:
        super().__init__(
            rule="NoCircularDepartmentReference",
            message="Циклическая ссылка в иерархии подразделений",
        )
