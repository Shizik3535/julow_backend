...
class AddOrgOwnerCommand(BaseCommand):
    """
    Команда добавления со-владельца организации.
...
class AddOrgOwnerHandler(BaseCommandHandler[AddOrgOwnerCommand, None]):
    """
    Обработчик добавления со-владельца.

    Загружает Organization, вызывает add_owner, сохраняет.
    """
    ...
    async def handle(self, command: AddOrgOwnerCommand) -> None:
        ...
        org.add_owner(Id.from_string(command.user_id))
