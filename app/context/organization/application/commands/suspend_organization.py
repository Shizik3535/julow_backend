...
class SuspendOrganizationCommand(BaseCommand):
    """
    Команда приостановки организации.
...
class SuspendOrganizationHandler(BaseCommandHandler[SuspendOrganizationCommand, None]):
    """
    Обработчик приостановки организации.

    Загружает Organization, вызывает suspend, сохраняет.
    """
    ...
    async def handle(self, command: SuspendOrganizationCommand) -> None:
        ...
        org.suspend(reason=command.reason)
