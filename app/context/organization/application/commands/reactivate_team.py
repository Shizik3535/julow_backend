...
class ReactivateTeamCommand(BaseCommand):
    """
    Команда реактивации команды.
...
class ReactivateTeamHandler(BaseCommandHandler[ReactivateTeamCommand, None]):
    """
    Обработчик реактивации команды.

    Загружает Team, вызывает reactivate, сохраняет.
    """
    ...
    async def handle(self, command: ReactivateTeamCommand) -> None:
