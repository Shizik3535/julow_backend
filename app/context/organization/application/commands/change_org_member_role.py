...
class ChangeOrgMemberRoleCommand(BaseCommand):
    """
    Команда изменения роли участника организации.
...
class ChangeOrgMemberRoleHandler(BaseCommandHandler[ChangeOrgMemberRoleCommand, None]):
    """
    Обработчик изменения роли участника организации.

    Загружает OrgMembership, вызывает change_member_role, сохраняет.
    """
    ...
    async def handle(self, command: ChangeOrgMemberRoleCommand) -> None:
