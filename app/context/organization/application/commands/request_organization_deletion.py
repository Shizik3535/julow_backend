...
class RequestOrganizationDeletionCommand(BaseCommand):
    """
    Команда запроса удаления организации.
...
class RequestOrganizationDeletionHandler(BaseCommandHandler[RequestOrganizationDeletionCommand, None]):
    """
    Обработчик запроса удаления организации.

    Загружает Organization, вызывает request_deletion, сохраняет.
    """
    ...
    async def handle(self, command: RequestOrganizationDeletionCommand) -> None:
