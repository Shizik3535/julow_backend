...
class SubmitTimeEntryCommand(BaseCommand):
    """Команда отправки записи на утверждение."""

    caller_id: str
    entry_id: str


class SubmitTimeEntryHandler(BaseCommandHandler[SubmitTimeEntryCommand, TimeEntryDTO]):
    """DRAFT → SUBMITTED. Только владелец."""
    ...
    async def handle(self, command: SubmitTimeEntryCommand) -> TimeEntryDTO:
