...
class RemoveTimeEntryTagCommand(BaseCommand):
    """Команда удаления тега из записи времени."""
...
class RemoveTimeEntryTagHandler(BaseCommandHandler[RemoveTimeEntryTagCommand, TimeEntryDTO]):
    """Удалить тег из записи времени. Только владелец, в DRAFT."""
    ...
    async def handle(self, command: RemoveTimeEntryTagCommand) -> TimeEntryDTO:
        ...
        entry.remove_tag(Id.from_string(command.tag_id))
