...
class AddProjectOwnerCommand(BaseCommand):
    """
    Команда добавления со-владельца проекта.
...
class AddProjectOwnerHandler(BaseCommandHandler[AddProjectOwnerCommand, None]):
    """Обработчик добавления со-владельца проекта."""
    ...
    async def handle(self, command: AddProjectOwnerCommand) -> None:
        ...
        project.add_owner(Id.from_string(command.user_id))
