...
class ReactivateProjectCommand(BaseCommand):
    """
    Команда реактивации проекта.
...
class ReactivateProjectHandler(BaseCommandHandler[ReactivateProjectCommand, None]):
    """Обработчик реактивации проекта."""
    ...
    async def handle(self, command: ReactivateProjectCommand) -> None:
