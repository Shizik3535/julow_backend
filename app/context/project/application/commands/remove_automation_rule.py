...
class RemoveAutomationRuleCommand(BaseCommand):
    """
    Команда удаления правила автоматизации.
...
class RemoveAutomationRuleHandler(BaseCommandHandler[RemoveAutomationRuleCommand, None]):
    """Обработчик удаления правила автоматизации."""
    ...
    async def handle(self, command: RemoveAutomationRuleCommand) -> None:
        ...
        board.remove_automation_rule(Id.from_string(command.rule_id))
