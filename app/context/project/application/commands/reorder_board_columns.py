...
class ReorderBoardColumnsCommand(BaseCommand):
    """
    Команда переупорядочивания колонок доски.
...
class ReorderBoardColumnsHandler(BaseCommandHandler[ReorderBoardColumnsCommand, None]):
    """Обработчик переупорядочивания колонок доски."""
