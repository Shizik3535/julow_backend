...
class RequestProjectDeletionCommand(BaseCommand):
    """
    Команда запроса удаления проекта.
...
class RequestProjectDeletionHandler(BaseCommandHandler[RequestProjectDeletionCommand, None]):
    """Обработчик запроса удаления проекта."""
