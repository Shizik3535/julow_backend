...
class StartSprintHandler(BaseCommandHandler[StartSprintCommand, None]):
    """Обработчик запуска спринта."""
    ...
    async def handle(self, command: StartSprintCommand) -> None:
