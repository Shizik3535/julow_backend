...
class SuspendProjectCommand(BaseCommand):
    """
    Команда приостановки проекта.
...
class SuspendProjectHandler(BaseCommandHandler[SuspendProjectCommand, None]):
    """Обработчик приостановки проекта."""
    ...
    async def handle(self, command: SuspendProjectCommand) -> None:
        ...
        project.suspend(reason=command.reason)
