...
class DeleteProjectRoleCommand(BaseCommand):
    """
    Команда удаления роли проекта.
...
class DeleteProjectRoleHandler(BaseCommandHandler[DeleteProjectRoleCommand, None]):
    """Обработчик удаления роли проекта."""
