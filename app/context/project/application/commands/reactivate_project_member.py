...
class ReactivateProjectMemberCommand(BaseCommand):
    """
    Команда реактивации участника проекта.
...
class ReactivateProjectMemberHandler(BaseCommandHandler[ReactivateProjectMemberCommand, None]):
    """Обработчик реактивации участника проекта."""
    ...
    async def handle(self, command: ReactivateProjectMemberCommand) -> None:
        ...
        membership.reactivate_member(Id.from_string(command.user_id))
