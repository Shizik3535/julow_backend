...
class DeactivateProjectMemberCommand(BaseCommand):
    """
    Команда деактивации участника проекта.
...
class DeactivateProjectMemberHandler(BaseCommandHandler[DeactivateProjectMemberCommand, None]):
    """Обработчик деактивации участника проекта."""
    ...
    async def handle(self, command: DeactivateProjectMemberCommand) -> None:
        ...
        membership.deactivate_member(user_id, is_owner=is_owner)
