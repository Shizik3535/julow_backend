...
async def lifespan(app: FastAPI):
    ...
    async def _register_celery_tasks() -> None:
        ...
        from app.context.filestorage.infrastructure.scheduling.celery_tasks import scan_file_for_virus_task
        ...
        celery_adapter.register_task("filestorage.scan_file_for_virus", scan_file_for_virus_task)
