"""Интеграционные тесты RemoveWorkspaceMemberHandler."""
...
class TestRemoveWorkspaceMemberHandler:
    """Тесты RemoveWorkspaceMemberHandler."""

    @pytest.fixture
    def handler(self, ws_repo, ws_membership_repo) -> RemoveWorkspaceMemberHandler:
        return RemoveWorkspaceMemberHandler(
            ws_repo=ws_repo,
