"""Интеграционные тесты UpdateAutomationRuleHandler (реальные repos + реальные порты)."""
...
class TestUpdateAutomationRuleHandler:
    """Тесты UpdateAutomationRuleHandler."""

    @pytest.fixture
    def handler(self, board_repo, permission_checker_stub, event_bus_stub) -> UpdateAutomationRuleHandler:
        return UpdateAutomationRuleHandler(
            board_repo=board_repo,
            permission_checker=permission_checker_stub,
            event_bus=event_bus_stub,
        )

    async def test_update_automation_rule_success(self, handler, board_repo, make_project_with_membership) -> None:
        ...
        cmd = UpdateAutomationRuleCommand(
    ...
    async def test_update_automation_rule_board_not_found(self, handler) -> None:
        cmd = UpdateAutomationRuleCommand(
