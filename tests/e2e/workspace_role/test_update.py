...
class TestUpdateWorkspaceRole:
    ...
    async def test_update_role_success_owner(self, client: AsyncClient):
    ...
    async def test_update_role_success_admin(self, client: AsyncClient):
        """200 — admin обновляет."""
        ws = await create_workspace_with_owner(client)
    ...
    async def test_update_role_no_auth(self, client: AsyncClient):
        """401 — без токена."""
        ws = await create_workspace_with_owner(client)
        resp = await client.patch(
    ...
    async def test_update_role_forbidden_system_role(self, client: AsyncClient):
    ...
    async def test_update_role_forbidden_manager(self, client: AsyncClient):
        """403 — manager."""
        ws = await create_workspace_with_owner(client)
