...
class TestGetWorkspace:
    ...
    async def test_get_success_owner(self, client: AsyncClient):
    ...
    async def test_get_success_admin(self, client: AsyncClient):
    ...
    async def test_get_success_member(self, client: AsyncClient):
    ...
    async def test_get_forbidden_not_member(self, client: AsyncClient):
