...
class TestUpdateDepartment:
    ...
    async def test_update_department_success(self, client) -> None:
    ...
    async def test_update_department_forbidden(self, client) -> None:
    ...
    async def test_update_department_not_found(self, client) -> None:
