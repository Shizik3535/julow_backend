...
class TestSuspendOrganization:
    ...
    async def test_suspend_organization_success(self, client) -> None:
    ...
    async def test_suspend_organization_already_suspended(self, client) -> None:
    ...
    async def test_suspend_organization_forbidden(self, client) -> None:
    ...
    async def test_suspend_organization_not_found(self, client) -> None:
