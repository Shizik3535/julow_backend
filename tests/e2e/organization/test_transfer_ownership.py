...
class TestTransferOwnership:
    ...
    async def test_transfer_ownership_success(self, client) -> None:
    ...
    async def test_transfer_ownership_forbidden(self, client) -> None:
    ...
    async def test_transfer_ownership_not_found(self, client) -> None:
