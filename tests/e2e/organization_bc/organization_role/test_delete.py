...
class TestDeleteRole:
    ...
    async def test_delete_role_system_forbidden(self, client, org_with_owner) -> None:
    ...
    async def test_delete_role_forbidden(self, client, org_with_owner) -> None:
    ...
    async def test_delete_role_not_found(self, client, org_with_owner) -> None:
        """404 — роль не найдена."""
        owner = org_with_owner
        resp = await client.delete(
    ...
    async def test_delete_role_success(self, client, org_with_owner) -> None:
