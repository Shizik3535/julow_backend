...
class TestAddSSOIntegration:
    ...
    async def test_add_sso_integration_success(self, client, org_with_owner) -> None:
    ...
    async def test_add_sso_integration_forbidden(self, client, org_with_owner) -> None:
    ...
    async def test_add_sso_integration_not_found(self, client, org_with_owner) -> None:
    ...
    async def test_add_sso_integration_validation(self, client, org_with_owner) -> None:
