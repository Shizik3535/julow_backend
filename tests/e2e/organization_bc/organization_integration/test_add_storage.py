...
class TestAddStorage:
    ...
    async def test_add_storage_success(self, client, org_with_owner) -> None:
    ...
    async def test_add_storage_forbidden(self, client, org_with_owner) -> None:
    ...
    async def test_add_storage_not_found(self, client, org_with_owner) -> None:
    ...
    async def test_add_storage_validation(self, client, org_with_owner) -> None:
