...
class TestUpdateStorage:
    ...
    async def test_update_storage_success(self, client, org_with_owner) -> None:
    ...
    async def test_update_storage_forbidden(self, client, org_with_owner) -> None:
    ...
    async def test_update_storage_not_found(self, client, org_with_owner) -> None:
