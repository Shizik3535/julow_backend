...
class TestReactivateTeam:
    ...
    async def _create_and_deactivate_team(self, client, owner) -> str:
        ...
        return team_id
    async def test_reactivate_team_already_active(self, client, org_with_owner) -> None:
    ...
    async def test_reactivate_team_forbidden(self, client, org_with_owner) -> None:
    ...
    async def test_reactivate_team_not_found(self, client, org_with_owner) -> None:
    ...
    async def test_reactivate_team_success(self, client, org_with_owner) -> None:
