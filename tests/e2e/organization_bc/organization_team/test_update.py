...
class TestUpdateTeam:
    ...
    async def test_update_team_success(self, client, org_with_owner) -> None:
    ...
    async def test_update_team_forbidden(self, client, org_with_owner) -> None:
    ...
    async def test_update_team_not_found(self, client, org_with_owner) -> None:
