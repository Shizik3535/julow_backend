...
class TestRemoveMember:
    ...
    async def test_remove_member_success(self, client, org_with_owner) -> None:
    ...
    async def test_remove_member_forbidden(self, client, org_with_owner) -> None:
    ...
    async def test_remove_member_not_found(self, client, org_with_owner) -> None:
