...
class TestAddMember:
    ...
    async def test_add_member_success(self, client, org_with_owner) -> None:
    ...
    async def test_add_member_conflict(self, client, org_with_owner) -> None:
    ...
    async def test_add_member_forbidden(self, client, org_with_owner) -> None:
    ...
    async def test_add_member_org_not_found(self, client, org_with_owner) -> None:
    ...
    async def test_add_member_validation(self, client, org_with_owner) -> None:
