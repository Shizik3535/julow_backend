...
class TestUpdateMemberDisplayName:
    ...
    async def test_update_display_name_success(self, client, org_with_owner) -> None:
    ...
    async def test_update_display_name_forbidden(self, client, org_with_owner) -> None:
    ...
    async def test_update_display_name_not_found(self, client, org_with_owner) -> None:
