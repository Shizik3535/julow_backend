...
class TestRevokeInvitation:
    ...
    async def test_revoke_invitation_success(self, client, org_with_owner) -> None:
    ...
    async def test_revoke_invitation_forbidden(self, client, org_with_owner) -> None:
    ...
    async def test_revoke_invitation_not_found(self, client, org_with_owner) -> None:
