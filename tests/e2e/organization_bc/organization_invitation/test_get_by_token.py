...
class TestGetInvitationByToken:
    ...
    async def test_get_invitation_by_token_success(self, client, org_with_owner) -> None:
    ...
    async def test_get_invitation_by_token_not_found(self, client, org_with_owner) -> None:
        """404 — токен не найден."""
        owner = org_with_owner
        resp = await client.get(
