...
class TestDeactivateSSOIntegration:
    ...
    async def test_deactivate_sso_integration_success(self, client) -> None:
    ...
    async def test_deactivate_sso_integration_forbidden(self, client) -> None:
    ...
    async def test_deactivate_sso_integration_not_found(self, client) -> None:
