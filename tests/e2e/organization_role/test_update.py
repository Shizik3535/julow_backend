...
class TestUpdateRole:
    ...
    async def test_update_role_success(self, client) -> None:
    ...
    async def test_update_role_system_forbidden(self, client) -> None:
    ...
    async def test_update_role_forbidden(self, client) -> None:
    ...
    async def test_update_role_not_found(self, client) -> None:
        """404 — роль не найдена."""
        owner = await create_org_with_owner(client)
        resp = await client.patch(
