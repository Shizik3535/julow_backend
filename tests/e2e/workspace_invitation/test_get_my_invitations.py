...
class TestGetMyWorkspaceInvitations:
    ...
    async def test_my_invitations_pending(self, client: AsyncClient) -> None:
    ...
    async def test_my_invitations_with_status_filter(self, client: AsyncClient) -> None:
    ...
    async def test_my_invitations_pagination(self, client: AsyncClient) -> None:
