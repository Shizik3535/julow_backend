...
class TestDeactivateWorkspaceMember:
    ...
    async def test_deactivate_success_owner(self, client: AsyncClient, workspace_owner):
    ...
    async def test_deactivate_success_admin(self, client: AsyncClient, workspace_owner):
    ...
    async def test_deactivate_no_auth(self, client: AsyncClient, workspace_owner):
        """401 — без токена."""
        ws = workspace_owner
        resp = await client.post(
    ...
    async def test_deactivate_forbidden_manager(self, client: AsyncClient, workspace_owner):
    ...
    async def test_deactivate_not_found(self, client: AsyncClient, workspace_owner):
    ...
    async def test_deactivate_conflict_last_owner(self, client: AsyncClient, workspace_owner):
