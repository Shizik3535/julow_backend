...
class TestChangeWorkspaceMemberRole:
    ...
    async def test_change_role_success_owner(self, client: AsyncClient, workspace_owner):
    ...
    async def test_change_role_success_admin(self, client: AsyncClient, workspace_owner):
    ...
    async def test_change_role_no_auth(self, client: AsyncClient, workspace_owner):
        """401 — без токена."""
        ws = workspace_owner
        resp = await client.patch(
    ...
    async def test_change_role_forbidden_manager(self, client: AsyncClient, workspace_owner):
    ...
    async def test_change_role_forbidden_member(self, client: AsyncClient, workspace_owner):
        """403 — member."""
        ws = workspace_owner
    ...
    async def test_change_role_not_found(self, client: AsyncClient, workspace_owner):
    ...
    async def test_change_role_validation_missing_role(self, client: AsyncClient, workspace_owner):
