...
class TestCreateWorkspaceTeam:
    ...
    async def test_create_team_success_owner(self, client: AsyncClient, workspace_owner):
    ...
    async def test_create_team_success_admin(self, client: AsyncClient, workspace_owner):
    ...
    async def test_create_team_success_manager(self, client: AsyncClient, workspace_owner):
    ...
    async def test_create_team_no_auth(self, client: AsyncClient, workspace_owner):
        """401 — без токена."""
        ws = workspace_owner
        resp = await client.post(
            f"{API}/workspaces/{ws['ws_id']}/teams",
    ...
    async def test_create_team_forbidden_member(self, client: AsyncClient, workspace_owner):
    ...
    async def test_create_team_validation_missing_name(self, client: AsyncClient, workspace_owner):
