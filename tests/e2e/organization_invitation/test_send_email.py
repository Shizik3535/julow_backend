...
class TestSendInvitation:
    ...
    async def test_send_invitation_success(self, client) -> None:
    ...
    async def test_send_invitation_conflict(self, client) -> None:
    ...
    async def test_send_invitation_forbidden(self, client) -> None:
    ...
    async def test_send_invitation_not_found(self, client) -> None:
    ...
    async def test_send_invitation_validation(self, client) -> None:
