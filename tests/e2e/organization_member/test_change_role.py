...
class TestChangeMemberRole:
    ...
    async def test_change_member_role_success(self, client) -> None:
    ...
    async def test_change_member_role_forbidden(self, client) -> None:
    ...
    async def test_change_member_role_not_found(self, client) -> None:
