...
class TestRemoveOwner:
    ...
    async def test_remove_owner_success(self, client) -> None:
    ...
    async def test_remove_owner_last_owner(self, client) -> None:
    ...
    async def test_remove_owner_forbidden(self, client) -> None:
    ...
    async def test_remove_owner_not_found(self, client) -> None:
