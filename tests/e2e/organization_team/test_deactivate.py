...
class TestDeactivateTeam:
    ...
    async def test_deactivate_team_success(self, client) -> None:
    ...
    async def test_deactivate_team_already_deactivated(self, client) -> None:
    ...
    async def test_deactivate_team_forbidden(self, client) -> None:
    ...
    async def test_deactivate_team_not_found(self, client) -> None:
